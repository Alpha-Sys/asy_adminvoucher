    ...
    <tr>
        ...
        <td style="vertical-align: top;">
            <form name="myedit" id="myedit" action="[{ $oViewConf->getSelfLink() }]" method="post">
                [{ $oViewConf->getHiddenSid() }]
                <input type="hidden" name="cl" value="asy_voucherserie_export">
                <input type="hidden" name="fnc" value="exportAllUsedVouchers">
                <input type="hidden" name="oxid" value="[{$oxid}]">
                <input type="hidden" name="editval[oxvoucherseries__oxid]" value="[{$oxid}]">
                ...
                <table cellspacing="2" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td class="edittext"><br>
                            <input type="submit" class="edittext" name="save" value="[{ oxmultilang ident="ASY_VOUCHER_EXPORT_USED_ALL" }]" [{ $readonly }] onClick="Javascript:changeFnc('exportUsedVouchers');">
                        </td>
                    </tr>
                </table>
            </form>
