...
<input type="hidden" name="editval[oxvoucherseries__oxid]" value="[{$oxid}]">
        ...
        [{block name="asy_voucherserie_generate_batch"}]
            ...
            <tr>
                ...
                <td class="edittext" style="color: #00B910; padding-left: 8px"><img src="[{$oViewConf->getModuleUrl('asy_adminvoucher')}]views/admin/img/asy_tick.png" alt="success" title="success">[{$sGenerate_Success_Message}]</td>
                [{else}]
                <td class="edittext"></td>
                [{/if}]
            </tr>
    ...
    <input type="hidden" name="editval[oxvoucherseries__oxid]" value="[{$oxid}]">
        ...
        [{block name="asy_voucherserie_generate_random"}]
            ...
            <tr>
                ...
                <td class="edittext" style="color: #00B910; padding-left: 8px"><img src="[{$oViewConf->getModuleUrl('asy_adminvoucher')}]views/admin/img/asy_tick.png" alt="success" title="success">[{$sGenerate_Random_Success_Message}]</td>
                [{else}]
                <td class="edittext"></td>
                [{/if}]
            </tr>
